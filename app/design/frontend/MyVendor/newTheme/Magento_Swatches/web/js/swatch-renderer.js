    ...
    $.widget('mage.SwatchRenderer', {
        ...
        _RenderControls: function () {
            ...
            $.each(this.options.jsonConfig.attributes, function () {
                ...
                const  $swatchOptions = $(container).find(`[data-attribute-id='${item.id}']`).find('.swatch-option');
                const $firstOption = $swatchOptions.first()
                if ($firstOption.length){
                    $firstOption.attr('aria-checked', true).addClass('selected')
                }
            });
        ...
        _OnClick: function ($this, $widget) {
            console.log('Custom logic: Option clicked!', $this);
